...
Additionally, integrating **synthetic limit-order-book market simulation** (see reference) enables university-wide competitions under controlled and repeatable market scenarios (stress regimes, low-liquidity environments, volatility shocks), allowing fair evaluation and deeper learning beyond fitting to historical data.

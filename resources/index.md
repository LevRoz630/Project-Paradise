...
[GitHub Flow](https://docs.github.com/en/get-started/using-github/github-flow){:target="_blank"} | [GitHub Projects](https://docs.github.com/en/issues/planning-and-tracking-with-projects){:target="_blank"}

### Research

[How to Read a Paper](http://ccr.sigcomm.org/online/files/p83-keshavA.pdf){:target="_blank"} (2-page guide)

### Machine Learning

[Rules of Machine Learning](https://developers.google.com/machine-learning/guides/rules-of-ml){:target="_blank"} (Google)
...
**Programming:** [Python for Finance: Mastering Data-Driven Finance](https://annas-archive.org/md5/73c51b4cae43a421626aa460a288fbc9){:target="_blank"}
...
[Essential Poker Math](https://annas-archive.org/md5/04ee8ac2731df12fecb9fb21c97324ca){:target="_blank"} | [MIT Poker Theory Course](https://ocw.mit.edu/courses/15-s50-poker-theory-and-analytics-january-iap-2015/download/){:target="_blank"}

Note: Some links go to Anna's Archive for academic materials
